defmodule NsparkWeb.Router do
  use NsparkWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {NsparkWeb.Layouts, :root}
  ...
  scope "/", NsparkWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {NsparkWeb.LiveUserAuth, :live_user_required}
      #
      # If an authenticated user *may* be present:
      # on_mount {NsparkWeb.LiveUserAuth, :live_user_optional}
      #
  ...
  scope "/api/json" do
    ...
    forward "/", NsparkWeb.AshJsonApiRouter
  end
  ...
  # scope "/api", NsparkWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:nspark, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: NsparkWeb.Telemetry
